...
const ALLOWED_ENV_KEYS = [
  ...
  'CAPSULE_CINEMA_LOCAL_CHANNELS_DIR', 'CAPSULE_CINEMA_DEFAULT_IMAGE_ENGINE',
  // LLM 规划
  ...
  'DOUBAO_TTS_API_KEY', 'DOUBAO_TTS_RESOURCE_ID', 'DOUBAO_TTS_MODEL',
  'DOUBAO_TTS_SPEAKER', 'DOUBAO_TTS_WS_URL',
  // RunningHub 公开工作流示例
  'RUNNINGHUB_API_KEY', 'RUNNINGHUB_BASE_URL', 'RUNNINGHUB_TIMEOUT_SECONDS',
  'WANANIMATE2_API_KEY', 'WANANIMATE2_WEBAPP_ID',
