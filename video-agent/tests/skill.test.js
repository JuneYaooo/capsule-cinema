// tests/skill.test.js — video-agent OpenClaw Skill 基础测试
...
function testCapsuleStoreExists() {
  ...
  assert.ok(!existsSync(join(SKILL_DIR, 'capsules')), '不应包含旧 Markdown capsules/ 目录');
...
// 测试 14: 默认输出目录应落在仓库根 output/，不能落进 video-agent/output/
...
// 运行所有测试
console.log('video-agent OpenClaw Skill 测试\n');
