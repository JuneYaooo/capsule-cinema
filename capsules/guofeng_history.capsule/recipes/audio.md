...
- Lock the provider-side speed to `0.88`; production samples measured 52.776 and 58.320 seconds at `0.8`, and 44.964 seconds at `0.9`. Those samples project to 47.98, 53.02, and 45.99 seconds at `0.88`, inside the 45-55 second release gate.
