...
- Lock the provider-side speed to `0.9`; production samples at `0.8` measured 52.776 and 58.320 seconds, which project to 46.9-51.8 seconds at `0.9` and fit the 45-55 second release gate.
