...
def extract_douyin_reference(douyin_text, enable_transcript=True, enable_video_analysis=True, save_video=False):
    ...
    The standalone douyin downloader/crawler is not bundled in this package. Keeping this
    shim prevents legacy optional inputs from crashing the full-video flow.
    """
