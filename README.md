...
| 已注册能力 | 当前覆盖 | 适合支撑 |
| --- | --- | --- |
| 图片生成 | gpt-image-2、gpt-image-2-pro、Seedream 5、Gemini 3 Pro；支持文生图、图生图和部分角色参考 | 通用 AI 视频、电商商品图、封面图、国风和艺术风格图 |
| AI 视频生成 | Seedance、Seedance 2.0、Jimeng 3.5 Pro、Veo 3、Veo 3.1；支持文生视频、图生视频和部分首尾帧 | 通用 AI 视频、产品演示、艺术短片、剧情镜头 |
| TTS 配音 | Universal TTS，当前接 MiniMax 和豆包 provider，按 voice catalog 选择音色 | 口播、旁白、知识讲解、电商解说、剧情旁白 |
| AI 音乐和 BGM | Suno 原创音乐生成，也支持授权音乐搜索和用户提供音频 | 音乐 MV、氛围短片、ASMR、剧情转场和背景乐 |
| 对口型和数字人 | RunningHub LTX、Wan2.2、InfiniteTalk；支持图片+音频和视频+音频对口型 | 数字人口播、产品说明、虚拟主播、真人素材换音轨 |
| 动作模仿 | RunningHub 动作迁移，支持单人、多人和舞蹈参考 | 跳舞视频、动作迁移、角色表演、挑战类短片 |
| 剪辑和字幕 | 视频拼接、BGM 混音、字幕烧录、自适应字幕和转码 | 真实素材混剪、AI 分镜拼接、口播 B-roll、发布版整理 |
| 质检和视频分析 | 本地视频 QA、质量评分、语言检测、Gemini 视频分析和参考视频拆解 | 发布检查、参考视频生成胶囊草稿、返工建议 |
